...
export const tools: Record<ToolSlug, ToolDefinition> = {
  ...
  mietbewerbung: {
    ...
    fields: [
      ...
      { key: "targetAddress",   label: "Adresse der Wunsch-Wohnung",       type: "address",  required: false },
  ...
  jobbewerbung: {
    ...
    fields: [
      ...
      { key: "companyAddress",  label: "Adresse des Unternehmens",             type: "address",  required: false },
      { key: "whyCompany",      label: "Warum dieses Unternehmen?",            type: "textarea", required: false,
  ...
  "kuendigung-arbeit": {
    ...
    fields: [
      ...
      { key: "employerAddress",  label: "Adresse des Arbeitgebers",    type: "address", required: true  },
      { key: "noticePeriod",     label: "Kündigungsfrist",             type: "select", required: false, section: "Kündigung",
