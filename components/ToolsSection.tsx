    ...
    <RevealOnScroll delay={delay} className="h-full">
      ...
      >
        <div>
          ...
          <h3 className="font-serif text-xl font-semibold leading-snug text-swiss-black">{title}</h3>
  ...
  return (
    <section id="tools" className="px-6 py-24 md:py-32">
      <div className="mx-auto max-w-content">
        <RevealOnScroll>
          <h2 className="font-serif text-4xl font-semibold text-swiss-black md:text-5xl">
            {dict.tools.title}
          </h2>
        </RevealOnScroll>
