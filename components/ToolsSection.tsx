  ...
  return (
    ...
    >
      <div>
        ...
        <h3 className="font-serif text-xl font-medium leading-snug text-swiss-black">{title}</h3>
        <p className="mt-2 text-sm leading-relaxed text-swiss-gray-500">{description}</p>
      </div>
      <div className="mt-6">
        <span className="text-xs font-medium uppercase tracking-widest text-swiss-gray-400 transition group-hover:text-swiss-black">
          Starten →
        </span>
      </div>
    </Link>
  ...
  return (
    <section id="tools" className="px-6 py-24 md:py-32">
      <div className="mx-auto max-w-content">
        <h2 className="font-serif text-4xl font-medium text-swiss-black md:text-5xl">
          {dict.tools.title}
        </h2>
